...
const Forum = () => {
  ...
  return (
    <>
      <Head>
        <title>Персонален сайт - портфолио - Вижте нашите цени</title>
        <meta
          name="description"
              ...
              <section className="max-w-2xl">
                <p className="">
                  <TransText trans={trans}>
                    ...
                    клиентите да видят, а да желаят да работят с Вас. Като ние
                    ще се погрижим да представим Вашите качества в най-добрата
                    Ви светлина.
                  </TransText>
                  <br />
                </p>
...
export const getServerSideProps = async ({ locale }) => {
  ...
  const [translations] = await Promise.all([
    serverSideTranslations(locale, ["portfolio", "common", "footer"]),
  ]);
