    ...
    <div className="index-bg ">
      <Head>
        ...
        <meta
          ...
          content="Strover Company изработва, поддържа и развива сайтове. Предлага услуги в дигиталния маркетинг: SEO, създаване, поддържане и развитие на социални мрежи, брандиране и ребрандиране. Всичко нужно на достъпна цена и с отлично обслужване."
        />
        <meta
          property="og:title"
