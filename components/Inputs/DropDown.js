    ...
    return (
            <div className="relative flex-col w-full flex-center">
              <button
                ...
                className={`$ text-black  border border-[#dadce0]   focus:ring-4 focus:outline-none focus:ring-blue-50  rounded-lg text-lg px-4 py-2.5 flex items-center justify-between  dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800 w-full`}
                type="button"
