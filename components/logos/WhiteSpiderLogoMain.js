...
export default function WhiteSpiderLogoMain({ width = "w-20", className }) {
  return (
    <div className={`${width} ${className}`}>
      <svg
        ...
        // className="fill-[#fc4c50]"
      >

<style>
      {
        ".st1{fill:none;stroke-width:.25}.st1,.st2,.st3,.st5,.st6{stroke:#fff;stroke-miterlimit:10}.st2{fill:none;stroke-width:2}.st3,.st5,.st6{fill:#fff}.st5,.st6{fill:none;stroke-width:.5}.st6{fill:#c33825;stroke-width:.25}.st9{fill:#fff}"
      }
    </style>
    <circle cx={107} cy={119.2} r={0.7} className="st1" />
    <path
    ...
    <path
      ...
      className="st2"
    />
    <circle cx={104.9} cy={188.7} r={5.1} className="st3" />
    <circle cx={151.1} cy={160.6} r={5.1} className="st3" />
    <circle cx={151.1} cy={44} r={5.1} className="st3" />
    <circle cx={112.4} cy={25.3} r={5.1} className="st3" />
    <path d="m71.6 120.1-12.5 12.2-.4 32.7 19.7 20.5" className="st2" />
    <circle cx={82.2} cy={188.7} r={5.1} className="st3" />
    <path d="M80.7 107.9H57.4l-21.9 21.7v26.3" className="st2" />
    <circle cx={35.5} cy={160.9} r={5.1} className="st3" />
    <path d="m79.1 98.9-20.6.4-22.6-22.1v-28" className="st2" />
    <circle cx={35.9} cy={44} r={5.1} className="st3" />
    <path
    ...
    />
    <path d="m84.1 151.2-.3-17.6 8.5-7.5" className="st2" />
    <circle
      cx={93.6}
      cy={125.2}
      r={1.7}
    ...
    <path
      ...
      className="st2"
    />
    <ellipse cx={73.8} cy={25.6} className="st3" rx={5} ry={5.1} />
  </svg>
    </div>
  );
}
