      ...
      <section className="flex flex-col mt-10 text-white gap-y-10 md:gap-y-64 md:pb-56 zeroToXl:text-center zeroToXl:gap-y-10">
        ...
        >
          <section className="container flex-col mt-2 text-left md:max-w-lg flex-center max-md:px-10">
            ...
            <section className="mt-2">
              ...
              <p className="">
                {t(`Изработка на сайт е основната дейност на Strover Company. Ние
            ...
            <section className="mt-2">
              ...
              <p className="">
                {t(`Ние използваме най-новите технологии и инструменти за да
            ...
            <section className="mt-2">
              ...
              <p className="">
                {t(`Ние също така предлагаме SEO оптимизация, за да подобрим
        ...
        >
          <section className="container flex-col mt-4 text-left md:max-w-lg flex-center max-md:px-10">
            <p>
              {t(`Дигиталният маркетинг е важен аспект за успешното развитие на
              вашия бизнес.`)}
            </p>
            <p className="mt-2">
              {t(`Strover Company предлага комплексни услуги в областта на
              дигиталния маркетинг, като SEO, социални медии, брандиране и
              ребрандиране.`)}
            </p>
            <p className="mt-2">
              {t(`Използвайки най-новите технологии и инструменти, помагаме на вашия
              бизнес да се развива и да се достига до по-голям брой клиенти.`)}
            </p>{" "}
            <p className="mt-2">
              {t(`Работим с вас за да разберем вашите нужди и цели и да създадем
              стратегия, която да отговаря на тях.`)}
            </p>
            <p>
              {t(`Предлагаме индивидуално подходящи решения и да подобрим вашето
              онлайн присъствие.`)}
            </p>
            <p className="mt-2">
              {t(`Доверете се на Strover Company за вашия дигитален маркетинг и
              наблюдавайте как вашия бизнес се развива и достига до повече
              клиенти.`)}
            </p>
            <p className="mt-2">
              {t(`С нашия знание и опит в дигиталния маркетинг, ще помогнем на вашия
