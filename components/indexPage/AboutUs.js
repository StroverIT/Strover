    ...
    >
      ...
      <section className="zeroToXl:flex-col zeroToXl:flex-center zeroToXl:gap-y-10">
        <div className="xl:flex-center flex-col xl:mr-10 xl:absolute xl:-top-20 xl:left-[380px]">
          ...
          <p className="max-w-xl max-md:container text-lg leading-8 text-white max-md:text-justify max-md:hypens-auto ">
        ...
        {secondCont && (
          ...
          >
            ...
            <p className="max-w-xl max-md:container text-lg leading-8 text-white max-md:hypens-auto max-md:text-justify">
        ...
        {thirdCont && (
          ...
          >
            ...
            <p className="max-w-xl text-lg  max-md:container leading-8 text-white max-md:text-justify max-md:hypens-auto">
