export const questionData = [
  ...
  },
  {
    ...
    text: `Ние не работим по готови темплейти, затова Ви предоставяме индивидуални дизайни, които са съобразени с вашите предпочитания за визия. Те са съчетаемост с успешни работещи практики, за да Ви предоставим  най-добрите решения. Разбира се първо минава през Вашето одобрение и корекции при необходимост. `,
    _id: "sadc2sa",
  },
  {
    title: "КАК КЛИЕНТИТЕ ЩЕ ДОСТИГАТ ДО МЕН",
    text: `Възможностите са безкрайни затова избираме най-оптималният начин, но най-честите начини са чрез социалните мрежи и/или оптимизиране на търсачките.`,
