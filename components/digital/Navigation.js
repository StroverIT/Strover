      ...
      <section className="items-center justify-between hidden px-28 md:flex ">
        ...
        <div>
          <ul className="flex items-center space-x-5">
            ...
            <li
              className="px-5 py-1 font-semibold tracking-[0.15rem] border-2 text-pink border-pink cursor-pointer"
        ...
        <AnimatePresence mode="wait">
          {isOpen && (
            <motion.div
              ...
              className="fixed top-0 left-0 w-screen h-screen bg-pink-200"
            >
              <motion.ul
