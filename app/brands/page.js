...
const Page = () => {
  return (
    <main className="relative grid w-screen h-screen grid-cols-2 ">
      {/* class="relative z-10 min-h-screen   break-words  min-w-screen bg-[#f6f9fc] flex justify-center flex-col pb-10" */}
      ...
      <div className="absolute top-0 left-0 w-screen h-screen">
        <div className="absolute z-10 w-screen h-screen opacity-50 bg-gray-150">
        </div>
        <div className="relative z-20 flex-col h-screen text-white flex-center">
        <Link href="/"><div className="flex-center"><span className="mr-1 text-xl"><IoArrowUndo/></span><span class="text-lg">Към начало</span></div></Link>

            <div className="">
                <h3 className="text-5xl">Очаквайте Скоро!</h3>
            </div>
        <section className="w-full max-w-xl mt-4">
            ...
            <h3 className="mt-8 text-center uppercase">
              Социални мрежи
            </h3>
